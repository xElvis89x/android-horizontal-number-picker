...
public class NumberPicker extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            mRightOfSelectionDividerRight = mLeftOfSelectionDividerLeft + 2 * mSelectionDividerWidth
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mLastDownEventX < mLeftOfSelectionDividerLeft) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float y = mInputText.getBaseline() + mInputText.getTop();//(getBottom() - getTop() + mTextSize) / 2;
        ...
        if (mVirtualButtonPressedDrawable != null
            ...
            if (mDecrementVirtualButtonPressed) {
                ...
                mVirtualButtonPressedDrawable.setBounds(0, 0, mLeftOfSelectionDividerLeft, getBottom());
                mVirtualButtonPressedDrawable.draw(canvas);
            }
            if (mIncrementVirtualButtonPressed) {
                //mVirtualButtonPressedDrawable.setState(PRESSED_STATE_SET);
                mVirtualButtonPressedDrawable.setState(PRESSED_ENABLED_STATE_SET);
                mVirtualButtonPressedDrawable.setBounds(mRightOfSelectionDividerRight, 0, getRight(),
                        getBottom());
                mVirtualButtonPressedDrawable.draw(canvas);
            }
        }
    ...
    private void initializeSelectorWheel() {
        ...
        float totalTextGapWidth = (getRight() - getLeft()) - totalTextWidth;
        ...
        // mInputText
        int editTextTextPosition = mInputText.getRight() / 2;
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            ...
            if (mIncrementVirtualButtonPressed) {
                ...
                invalidate(0, mRightOfSelectionDividerRight, getRight(), getBottom());
            }
            mDecrementVirtualButtonPressed = false;
            if (mDecrementVirtualButtonPressed) {
                invalidate(0, 0, getRight(), mLeftOfSelectionDividerLeft);
            }
        }
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_DECREMENT:
                    return createAccessibilityNodeInfoForVirtualButton(VIRTUAL_VIEW_ID_DECREMENT,
                            ...
                            mLeftOfSelectionDividerLeft + mSelectionDividerWidth,
                ...
                case VIRTUAL_VIEW_ID_INCREMENT:
                    return createAccessibilityNodeInfoForVirtualButton(VIRTUAL_VIEW_ID_INCREMENT,
                            ...
                            mRightOfSelectionDividerRight - mSelectionDividerWidth, getScrollY(),
                            getScrollX() + (getRight() - getLeft()), getScrollY() + (getBottom() - getTop()));
            }
